...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    <style>
        .progress { position:relative;height:30px; width:100%; border: 1px solid #7F98B2; padding: 1px; border-radius: 3px; }
    ...
    <div class="card">
      ...
      <div class="card-body">
			<div class="progress" style="display:none;">
                <div class="bar progress-bar bg-success progress-bar-striped"></div >
